...
require_relative 'lib/homebus-gpsd/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-gpsd'
  spec.version = HomebusGpsd::VERSION
  ...
  spec.homepage = 'https://github.com/romkey/homebus-gpsd'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/romkey/homebus-gpsd'
