...
require 'homebus-gpsd/options'
require 'homebus-gpsd/app'

require 'homebus/config'

class TestHomebusGpsdApp < HomebusGpsd::App
...
describe HomebusGpsd do
  context "Version number" do
    it "Has a version number" do
      expect(HomebusGpsd::VERSION).not_to be_nil
      expect(HomebusGpsd::VERSION.class).to be String
    end
  end 
end

describe HomebusGpsd::Options do
  context "Methods" do
    options = HomebusGpsd::Options.new
    ...
    it "Uses the VERSION constant" do
      expect(options.version).to eq(HomebusGpsd::VERSION)
    end
...
describe HomebusGpsd do
  context "Methods" do
    options = HomebusGpsd::Options.new
    app = TestHomebusGpsdApp.new(options)
